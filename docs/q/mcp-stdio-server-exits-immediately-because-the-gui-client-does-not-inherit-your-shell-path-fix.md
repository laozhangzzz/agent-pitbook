...
HTML query page: https://laozhangzzz.github.io/agent-pitbook/q/mcp-stdio-server-exits-immediately-because-the-gui-client-does-not-inherit-your-shell-path-fix.html
