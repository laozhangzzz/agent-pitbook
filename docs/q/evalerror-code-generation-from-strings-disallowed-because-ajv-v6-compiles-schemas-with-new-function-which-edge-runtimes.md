...
HTML query page: https://laozhangzzz.github.io/agent-pitbook/q/evalerror-code-generation-from-strings-disallowed-because-ajv-v6-compiles-schemas-with-new-function-which-edge-runtimes.html
