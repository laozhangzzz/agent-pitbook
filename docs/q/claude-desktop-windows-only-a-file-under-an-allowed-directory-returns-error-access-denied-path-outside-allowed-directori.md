...
HTML query page: https://laozhangzzz.github.io/agent-pitbook/q/claude-desktop-windows-only-a-file-under-an-allowed-directory-returns-error-access-denied-path-outside-allowed-directori.html
