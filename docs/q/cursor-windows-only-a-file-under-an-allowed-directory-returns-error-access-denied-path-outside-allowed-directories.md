...
HTML query page: https://laozhangzzz.github.io/agent-pitbook/q/cursor-windows-only-a-file-under-an-allowed-directory-returns-error-access-denied-path-outside-allowed-directories.html
