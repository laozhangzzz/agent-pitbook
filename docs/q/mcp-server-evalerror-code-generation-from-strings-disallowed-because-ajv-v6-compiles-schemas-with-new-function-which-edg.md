...
HTML query page: https://laozhangzzz.github.io/agent-pitbook/q/mcp-server-evalerror-code-generation-from-strings-disallowed-because-ajv-v6-compiles-schemas-with-new-function-which-edg.html
